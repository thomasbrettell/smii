...
<script lang="ts">
  ...
  const randomise = () => {
    mouthPoint1.set([randomRange(5, 20), randomRange(25, 50)]);
    mouthPoint2.set([randomRange($mouthPoint1[0], 20), randomRange(25, 50)]);
    mouthPoint3.set([randomRange(30, 45), randomRange(25, 50)]);

    const isFrown = $mouthPoint1[1] >= $mouthPoint2[1];

    mouthPoint4.set([
      randomRange($mouthPoint3[0], 45),
      randomRange(
        isFrown ? $mouthPoint3[1] : 25,
        isFrown ? 50 : $mouthPoint3[1]
      ),
    ]);
  };
  ...
  <div class="svg-root">
    ...
    >
      <path
        ...
        fill={SMILE_COLOR}
        stroke="none"
        transform={`translate(${eye1Pos[0]}, ${eye1Pos[1]})`}
      />
      <path
        id="eye-2"
        ...
        fill={SMILE_COLOR}
        stroke="none"
        transform={`translate(${eye2Pos[0]}, ${eye2Pos[1]})`}
      />
